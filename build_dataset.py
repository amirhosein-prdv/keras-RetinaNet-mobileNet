...
ap.add_argument("-v", "--val", default=config.VAL_CSV,
	help="path to output val CSV file")
ap.add_argument("-c", "--classes", default=config.CLASSES_CSV,
	help="path to output classes CSV file")
ap.add_argument("-s", "--split", type=float, default=config.TRAIN_TEST_VAL_SPLIT,
